package com.example.speechdemo.service;
...
import com.example.speechdemo.activity.RecordingActivity;
...
import com.example.speechdemo.util.WavConverter;
...
public class RecordingService extends Service {
	...
	private Notification createNotification() {
		...
		builder.setContentIntent(PendingIntent.getActivity(getApplicationContext(), 0,
				new Intent(getApplicationContext(), RecordingActivity.class), 0));
	...
	public void stopRecording() {
		...
		mDatabase.addRecording(mPrettyRecordingName,
				newFile.getAbsolutePath(), length, this.mMeetingId, this.mAgendaId, "wav", "", "0");
	...
	private File generateFile() {
		...
		filename += File.separator + "soundrecording";
